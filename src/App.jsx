  ...
  projects: [
    {
      ...
      links: { github: 'https://github.com/Nerya253/memory-game', demo: 'href=https://memory-nerya.duckdns.org' },
      status: 'done',
    },
    {
      title: 'CRM system',
      ...
      links: { github: 'https://github.com/Nerya253/CRM', demo: 'href=https://crm-nerya.duckdns.org' },
      status: 'done',
    },
  ],
};
    ...
    <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center', pt: 4 }}>
      ...
      <List>
        ...
        <ListItem disablePadding>
          <ListItemButton
            component="a"
            href="../public/Nerya_Levi_Resume.pdf"
